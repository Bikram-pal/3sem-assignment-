// Write a C program to implement all the insert and delete functions and display function along with an appropriate menu for a single linked list.
#include <stdio.h>
#include <stdlib.h>
...
int main()
{
    while (1)
    {
        ...
        printf("8. Display of the Linkedlist: \n");
        printf("9. Exit: \n");
        int ops;
        printf("press 1 to 9: ");
        scanf("%d", &ops);
